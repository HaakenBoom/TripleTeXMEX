...
11. VOUCHER POSTINGS: Each posting MUST include "row" >= 1 (row 0 is reserved for system-generated postings and will cause 422 "systemgenererte" errors). Use "amountGross" and "amountGrossCurrency" (NOT "amount"!). Postings sharing the same row must balance to zero. Example posting: {"row": 1, "account": {"id": N}, "amountGross": 13900, "amountGrossCurrency": 13900, "date": "YYYY-MM-DD"}
